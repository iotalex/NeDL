async function getRandomExcuse() {
  ...
  async function getOfficeExcuse() {
    // first build the API call string by starting with the URL
    var apiString = "https://excuser.herokuapp.com/v1/excuse/office";
  ...
  async function getCollegeExcuse() {
    // first build the API call string by starting with the URL
    var apiString = "https://excuser.herokuapp.com/v1/excuse/college/4";
  ...
  async function getChildrenExcuse() {
    // first build the API call string by starting with the URL
    var apiString = "https://excuser.herokuapp.com/v1/excuse/children/";
  ...
  async function getNumberExecuse() {
    // first build the API call string by starting with the URL
    var apiString = "https://excuser.herokuapp.com/v1/excuse/family/";
