...
namespace ShopKo // Note: actual namespace depends on the project name.
{
    internal class Program
    {
       ...
       //memberList.Add(new Member ("Katie", "woot@aol.org", "Regular Member" , 45, 99));
        ...
        memberList.Add(new Executive (2001, "bread@beads.org", "Executive Member" , 150, 500.00, 100));
        memberList.Add(new Executive (2001, "lumber@truss.biz", "Executive Member" , 300, 1000.01, 10.5));
